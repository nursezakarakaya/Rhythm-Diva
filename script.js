...
function preloadImages() { //Oyunu itch.io veya github pages'den ilk kez açarken bazı resimler geç yükleniyor onu önlemek için
    for (let i = 0; i < images.length; i++) {
        ...
        img.onload = function() {
            ...
            // Hepsi yüklendiğinde oyunu başlat
            if (yuklenenResimSayisi === images.length) {
                startGame();
            }
        };
